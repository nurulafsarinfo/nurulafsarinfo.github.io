...
const About = () => {
    return (
        <div className='w-11/12 mx-auto bg-[#020b29] rounded-2xl p-4 md:p-8'>
            ...
            <div className='grid md:grid-cols-5 '>
                <div className='col-span-2 space-y-2 md:block hidden pl-10'>
                    <div className='flex items-center space-x-4 border-l-3 border-[#8a31af] p-4'>
                ...
                <div className='col-span-3 md:ml-10 h-[420px] overflow-scroll'>
